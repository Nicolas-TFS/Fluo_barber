  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top + 34, paddingBottom: insets.bottom + 20 }]}>
      ...
      <View style={styles.form}>
        {verifying ? <Field label="Código de verificação" value={code} onChangeText={setCode} placeholder="000000" keyboardType="number-pad" colors={colors} /> : <><Field label="E-mail" value={email} onChangeText={setEmail} placeholder="voce@barbearia.com" keyboardType="email-address" colors={colors} /><Field label="Senha" value={password} onChangeText={setPassword} placeholder="Mínimo de 8 caracteres" secureTextEntry maxLength={64} colors={colors} /><Text style={[styles.passwordHint, { color: colors.mutedForeground }]}>{password.length} caracteres (mínimo 8)</Text><View nativeID="clerk-captcha" /></>}

...
function ClassicTabLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen name="agenda" options={{ title: 'Agenda', tabBarIcon: ({ color }) => isIOS ? <SymbolView name="calendar" tintColor={color} size={24} /> : <Feather name="calendar" size={22} color={color} /> }} />
      ...
      <Tabs.Screen name="more" options={{ title: 'Mais', tabBarIcon: ({ color }) => isIOS ? <SymbolView name="ellipsis" tintColor={color} size={24} /> : <Feather name="more-horizontal" size={22} color={color} /> }} />
    </Tabs>
  );
}

...
**How to apply:** Detectar o grupo de rotas públicas no layout raiz e montar apenas os providers neutros necessários. Manter Clerk e o estado autenticado na árvore usada pelas telas privadas.